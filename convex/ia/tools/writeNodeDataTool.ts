...
export const writeNodeDataTool = createTool({
  description:
    "A tool to write node data to a onCanvasNodeId (not a canvasNodeId but the nodeDataId linked to it).",
  args: z.object({
    nodeId: z.string().describe("The ID of the **nodeData** to write data to"),
  }),
