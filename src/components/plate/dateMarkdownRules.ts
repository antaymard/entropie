 ...
 *
 * L'attribut `value` (ISO) est la source de vérité pour le round-trip ;
 * le texte enfant n'est qu'un label lisible pour le LLM.
 *
...
export const dateMarkdownRules: MdRules = {
  date: {
